...
import './Header.css';
import sampleLocation from "../../hotelsData/LocationData";
    ...
    <div className="modal-dialog modal-dialog-centered" role="document">
      <div className="modal-content">
        <div className="modal-body">
          ...
          <select value={pincode} onChange={(e) => setPincode(e.target.value)}  className="pin-box form-control" placeholder="Please select your city...">
